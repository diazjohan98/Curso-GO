...
var analizarCmd = &cobra.Command{
	Use:   "analizar-db",
	Short: "Realiza un analisis exploratorio de los datos almacenados",
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("Analisis exploratorio de los datos almacenados")
		fmt.Println("=========================================================")
		...
		if err != nil {
			log.Fatalf("Error al obtener nombre: %v", err)
		}
		...
		fmt.Println("Dominios de correo mas comunes:")
